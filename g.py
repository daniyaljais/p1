...
OPENAI_API_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIxZjMwMDAwMzFAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.-c4ok0TU1wsXREvtXfZ6xgzVNTDZEUJJoA2mJUXQ4VU"
...
def interpret_task(task_description: str):
    ...
    response = "https://aiproxy.sanand.workers.dev/openai/v1/models"(
        model="gpt-4",
